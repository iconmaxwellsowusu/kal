...
<body>
    ...
    String union = (String)session.getAttribute("union");
        ...
        if(!position.equals("Union Manager") && !position.equals("admin")){
...
<div id="pcoded" class="pcoded">
    ...
    <div class="pcoded-container navbar-wrapper">
													  ...
													  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <h5 class="modal-title" id="exampleModalLongTitle">Update a Branch</h5>
       ...
       <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
        ...
        <script src="//cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js" type="text/javascript"></script>     <script type="text/javascript">
												getall();
                            ...
                            <div class="page-wrapper">
                                <div class="page-body">
                                   ...
                                   <!-- Employee Details  -->
                                      ...
                                      <div class="col-md-4 mb-3">
										<label for="" class="mt-1">Branch Manager</label>
                                         ...
                                         <div align="right">
                                           <button class="btn waves-effect waves-light btn-grd-success" onclick="add()">Add Branch</button>        
                                           </div>         
