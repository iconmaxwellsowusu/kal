...
//////////////////////////////////////**************   hellio txt msg  *****************************///////////////////////////////   
    ...
    pst = con.prepareStatement("update booking set passengerName=?,passengerPhone=?,emergencyPhone=?,trip=?,destination=?,seatNumber=?, idNumber=? where id =?");
						...
						out.flush();
							...
							out.flush();
								...
								out.flush();
									...
									else if(option.equals("searchPhone")){
										String query = "select * from booking where passengerPhone='"+fon+"'";
										rs = stmt.executeQuery(query);
									...
									while(rs.next())
									{
									    ...
									    String passengerName = rs.getString("passengerName");
									    String idcard = rs.getString("idNumber");
									    String emergencyPhone = rs.getString("emergencyPhone");
									    obj.put("passengerName", passengerName);
									    obj.put("passengerPhone", idcard);
									    obj.put("emergencyPhone", emergencyPhone);
