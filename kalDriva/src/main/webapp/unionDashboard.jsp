...
<head>
  ...
  <body>
    ...
    String position = (String)session.getAttribute("position");
        ...
        if( !position.equals("Union Manager")){
                    ...
                    <ul class="nav-right">
                        ...
                        <li class="user-profile header-notification">
                            ...
                            <ul class="show-notification profile-notification">
                                ...
                                <li class="waves-effect waves-light">
                                     <a class="dropdown-item" data-toggle="modal" data-target="#branch" style="cursor:pointer"><i class="fa-solid fa-user-group"></i>  &nbsp;  &nbsp;Add Branch Manager</a>
			                     </li>
